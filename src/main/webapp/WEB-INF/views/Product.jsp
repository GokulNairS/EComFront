...
<div class="container">
 <c:if test="${editMode}">
        <c:set var="url" value="productupdate"></c:set>
        </c:if>

        <c:if test="${!editMode}">
        <c:set var="url" value="productadd"></c:set>
        </c:if>
	...
	<form:form modelAttribute="product" action="${url}" method="post">
		...
		<div class="col-sm-12">
			...
			<div class="col-sm-12">
				<div class="row">
					<div class="col-xs-4">
						<label class="mail">Category:</label>
					</div>
					<div class="col-xs-8">
						<form:select path="category.category_id" class="form-control">
						<c:forEach items="${listcategory}" var="c">
						<form:option value="${c.category_id}">${c.category_Name}</form:option></c:forEach>
						</form:select></div>
				</div>
			</div>
			...
			<div class="col-sm-12">
				<div class="row">
					<div class="col-xs-4">
						<label class="mail">quantity :</label>
					</div>
					<div class="col-xs-8">
						<form:input type="text" name="email" id="email"
							placeholder="Enter your Description" class="form-control"
                                                        ...
                                                        <c:forEach items="${prodlist}" var="c">
                                                                <tr>
                                                                        ...
                                                                        <td class="td-actions text-right">
                                                                                ...
                                                                                <a href="editproduct?productName=${c.product_Name}" rel="tooltip"
                                                                                        class="btn btn-success btn-link btn-just-icon btn-sm"
                                                                                        data-original-title="" title="">
                                                                                        <i class="material-icons">edit</i>
                                                                                </a>
                                                                                <<a href="deleteproduct?productName=${c.product_Name}" rel="tooltip"
